        ...
        <section className="section-padding" style={{ background: "rgba(13,22,40,0.62)" }}>
          <div className="container max-w-[860px]">
            ...
            <p className="text-body-base text-secondary-text mb-4">
              30 years of experience in manufacturing operations, production planning, quality systems implementation, and plant operations. Holds a degree in Manufacturing Engineering Technology. Direct operational experience in SME precision manufacturing — stamping, fabrication, and metalforming operations serving automotive supply chains.
            </p>
            <p className="text-body-base text-secondary-text mb-4">
