      ...
      <PageShell onDemoClick={() => setDemoOpen(true)}>
        ...
        <section className="section-padding" style={{ background: "rgba(10,14,26,0.92)" }}>
          <div className="container max-w-[860px]">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              >
                <Activity size={24} style={{ color: "#00c8ff" }} />
              </div>
              <h1 className="text-h1 text-primary-text" style={{ fontFamily: "var(--font-rajdhani)" }}>
                EKAS for Medical Device Manufacturing
              </h1>
            </div>

            <p className="text-body-lg text-secondary-text mb-8">
              Medical device manufacturing operations require full traceability and audit-ready documentation for ISO 13485 and FDA 21 CFR Part 11 compliance.
            </p>
        ...
        <section className="section-padding" style={{ background: "rgba(13,22,40,0.62)" }}>
          <div className="container max-w-[860px]">
            <h2 className="text-h2 text-primary-text mb-4">
              Medical Device Manufacturing and EKAS Platform Applicability
            </h2>
            <p className="text-body-base text-secondary-text mb-6">
              Medical device manufacturing operations face strict regulatory requirements for device history records, process validation, and quality traceability. EKAS platform capabilities apply through governed metrics with full data provenance, production event traceability, and audit-ready documentation architecture.
            </p>
            ...
            <div className="p-4 rounded-lg mb-6" style={{ background: "rgba(0,200,255,0.04)" }}>
              ...
              <p className="text-body-sm text-secondary-text">
                ISO 13485 and FDA 21 CFR Part 11 requirements: EKAS provenance architecture includes production lot, machine, operator, timestamp, and calculation hash for every metric. This supports device history record (DHR) documentation, process validation traceability, complaint investigation (CAPA), and quality event audit trails required for FDA and regulatory compliance.
              </p>
            </div>
        ...
        <section className="section-padding" style={{ background: "rgba(10,14,26,0.72)" }}>
          <div className="container max-w-[640px] text-center">
            <h2 className="text-h2 text-primary-text mb-4">See EKAS for Medical Devices</h2>
            <p className="text-body-base text-secondary-text mb-8">
              Request a demo to see how EKAS provenance and traceability architecture supports ISO 13485 and FDA compliance.
            </p>
            <button onClick={() => setDemoOpen(true)} className="btn-primary">
              Request a Demo
            </button>
