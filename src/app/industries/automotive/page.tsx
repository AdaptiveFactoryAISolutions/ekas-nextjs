...
export const metadata: Metadata = {
  ...
  description: "IATF 16949 traceability and provenance architecture for automotive Tier 1 and Tier 2 suppliers. Full audit trail by design.",
};
